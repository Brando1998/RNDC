...
class AppGUI:
    ...
    def _setup_remesas(self):
        ...
        self.scale_sesiones = Scale(frame_sesiones, from_=1, to=10, orient=HORIZONTAL, length=200, command=self.actualizar_num_sesiones)
    ...
    def _setup_manifiestos(self):
        ...
        self.scale_sesiones_man = Scale(frame_sesiones_man, from_=1, to=10, orient=HORIZONTAL, length=200, command=self.actualizar_num_sesiones_man)
